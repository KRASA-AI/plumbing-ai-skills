...
version: 1.2
last_eval_score: 9.7
notes_for_next_eval: "v1.2 (2026-06-29, landscape monitor): the litigation watch from v1.1 resolved with concrete action — on June 8, 2026 the U.S. Supreme Court issued a grant-vacate-remand (GVR) in American Gas Association v. DOE (No. 25-879), vacating the D.C. Circuit decision that had upheld the commercial gas water-heater (and residential non-condensing furnace) standard and remanding for reconsideration in light of the Solicitor General's April 28, 2026 brief, in which DOE now states the rules rest on 'a legal error' and is considering a new rulemaking. Commercial Section 2 + Notes-for-the-Operator updated: the GVR does not repeal the rule or decide the merits, and the standard 'remains in effect,' but DOE has disavowed it and the probability of revision/repeal rose materially — so commercial-customer guidance moves further away from any regulatory-deadline urgency. v1.1's April 24, 2026 enforcement grace period framing is retained and now sits under the GVR. Residential May 6, 2029 guidance untouched. Watch for: D.C. Circuit action on remand; DOE's proposed new rulemaking / delay; any move that revives or vacates the standard."
---
...
For a commercial customer with a gas water heater above the rule's covered input range, anchor on the **October 6, 2026 commercial water heater standard requiring condensing efficiency** — but state it accurately alongside two developments that have softened it. The honest, current picture has three parts the customer needs together:
- The standard still takes legal effect October 6, 2026 on paper (the rule has not been repealed), AND
- DOE is exercising enforcement discretion to **delay enforcement** for covered commercial gas units manufactured between October 6, 2026 and October 6, 2027 (Enforcement Policy Statement, April 24, 2026), so manufacturers (e.g., A.O. Smith) are expected to keep producing and selling non-condensing commercial gas units through roughly late 2027, AND
- On **June 8, 2026 the U.S. Supreme Court vacated the lower-court decision that had upheld this standard** (a grant-vacate-remand, or GVR, in *American Gas Association v. DOE*) and sent the case back to the D.C. Circuit. DOE itself now says — through the Solicitor General's brief — that the rule rests on "a legal error," and the agency is considering a new rulemaking. This does **not** repeal the rule or decide the case, but it materially raises the chance the condensing-only commercial mandate is ultimately narrowed, delayed further, or overturned.

What this means for the customer: a like-for-like non-condensing replacement of a covered commercial unit is likely **still available** during the grace window, and the regulatory future of the mandate is now genuinely uncertain rather than fixed. The "buy before the October 2026 wall" urgency the customer may have read about has effectively moved out about a year on enforcement *and* is under active legal reconsideration. Frame the condensing-vs-non-condensing choice on total 10-year cost of ownership — not on a regulatory deadline. When the customer does choose a **condensing model**, explain the install differences (different vent material, different vent path, condensate management required, possibly different gas line sizing) and present it as a future-proofing and efficiency decision on its own merits, since the mandate backstop is now in doubt. Do not tell a commercial customer they "must" buy condensing by October 6, 2026 — that overstates both the enforcement posture and the now-unsettled legal status, and is the single most likely accuracy error on this skill right now.
...
- The commercial mandate's legal status is now actively unsettled. Two layers sit on top of the October 6, 2026 effective date: (1) the DOE April 24, 2026 enforcement grace period (no enforcement against covered commercial gas units manufactured Oct 6, 2026 – Oct 6, 2027), and (2) the **June 8, 2026 Supreme Court GVR** in *American Gas Association v. DOE* (No. 25-879), which vacated the D.C. Circuit ruling upholding the standard and remanded it for reconsideration after DOE's own Solicitor General conceded the rule is legally flawed and signaled a possible new rulemaking. A GVR is procedural — it wipes the lower court's ruling but does not itself strike the rule, which "remains in effect" pending the remand — yet it clearly increases the odds the commercial condensing mandate is narrowed, delayed, or overturned. Net effect for customer conversations: do not present the commercial standard as a settled deadline at all. It is the current operating reality, not a guaranteed end state — do not promise a customer either that it will be enforced on schedule or that it will be repealed. Re-check before making a multi-year commercial capital-timing commitment. See `knowledge-base/regulations/water-heater-efficiency-2026-2029.md` for the full enforcement-policy and litigation detail.
