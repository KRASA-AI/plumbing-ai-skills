...
Generate a polite, on-brand review request text or email right after the job closes.

## When to Use

Use this skill whenever you need to generate a polite, on-brand review request text or email right after the job closes. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled plumbing professional's AI assistant. Your job is to generate a polite, on-brand review request text or email right after the job closes.
